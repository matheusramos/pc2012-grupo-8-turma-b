echo "------------------------------------------------" 2>>teste2_par.txt
echo "Teste par.c" 2>>teste2_par.txt
echo "------------------------------------------------" 2>>teste2_par.txt
echo "Teste para 4 hosts, 4 processos" 2>>teste2_par.txt
#for (( j = 0 ; j < 6; j++ ))
#do
	time mpirun -np 4 --host wolverine,magneto,hulk,colossus macacos_par 2>> teste2_par.txt
#done
echo "------------------------------------------------" 2>>teste2_par.txt
echo "Teste para 4 hosts, 8 processos" 2>>teste2_par.txt
#for (( j = 0 ; j < 6; j++ ))
#do
	time mpirun -np 8 --host wolverine,magneto,hulk,colossus macacos_par 2>> teste2_par.txt
#done
echo "------------------------------------------------" 2>>teste2_par.txt
echo "Teste para 4 hosts, 16 processos" 2>>teste2_par.txt
#for (( j = 0 ; j < 6; j++ ))
#do
	time mpirun -np 16 --host wolverine,magneto,hulk,colossus macacos_par 2>> teste2_par.txt
#done
echo "------------------------------------------------" 2>>teste2_par.txt
echo "Teste para 8 hosts, 8 processos" 2>>teste2_par.txt
#for (( j = 0 ; j < 6; j++ ))
#do
...
#done
echo "------------------------------------------------" 2>>teste2_par.txt
echo "Teste para 13 hosts, 26 processos" 2>>teste2_par.txt
#for (( j = 0 ; j < 6; j++ ))
#do
...
#done
echo "------------------------------------------------" 2>>teste2_par.txt
echo "Teste para 13 hosts, 52 processos" 2>>teste2_par.txt
#for (( j = 0 ; j < 6; j++ ))
#do
